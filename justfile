...
dump-data: gen-data
    #!/usr/bin/env bash
    mkdir -p fixtures
    ./manage.py dumpdata --format json --indent 2 ingredients -o fixtures/ingredients.json
    ./manage.py dumpdata --format json --indent 2 recipes -o fixtures/recipes.json
